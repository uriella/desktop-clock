...
#define DEFAULT_ESP_WIFI_PASS "yourpassword"
...
void wifi_init_sta(void) {
  ...
  if (bits & WIFI_CONNECTED_BIT) {
    ESP_LOGI(TAG, "connected to ap SSID:%s password:%s", DEFAULTT_ESP_WIFI_SSID,
...
void app_main(void) {
  ...
  wifi_init_sta();
  xTaskCreate(updateTemperature, "temperature", )
}